...
// 예제 25-06 ----------------------------------------------------------
// console.log(Person);
// // ReferenceError: Cannot access 'Person' before initailization
...
// 예제 25-17 ----------------------------------------------------------
// class Person {
//   // constructor는 생략하면 아래와 같이 빈 constructor가 암묵적으로 정의됨
//   constructor() {}
// }
...
// // 접근자 프로퍼티를 통한 프로퍼티 값의 참조
// // 접근자 프로퍼티 fullName에 접근하며 getter 함수가 호출
...
// // 예제 25-37 ----------------------------------------------------------
// // Object.getOwnPropertyNames 는 비열거형(non-enumerable)을 포함한 모든 프로퍼티의 이름을 반환한다 (상속 제외)
...
// class Person {
//   constructor(name) {
//     this.name = name; // 인스턴스 프로퍼티는 기본적으로 public 하다
//   }
// }
...
//     return this.#name.trim(); // trim : 좌우열 공백 제거
//   }
// }
