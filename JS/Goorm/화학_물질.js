...
// 		while(true){
// 			result_temp = result.filter(x => x !==0);
// 			console.log("1",result, cnt, K)
			
// 			let mini = Math.min(...result_temp);
			
// 			if (mini === 0 || mini === Infinity){
// 				cnt++;
// 				result = result.map(x => x+M)
// 				mini = M;
// 				result_temp = result.filter(x => x !==0);
// 			}
// 			else	if(result_temp.length<3){
// 				cnt++;
// 				result = result.map(x => x+M);
// 				mini = M;
// 			}
